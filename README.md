...
ちまちまゆっくりアップデートしていきたいと思います。

また本サンプルデータ(フォントを除く、プログラム、画像、サウンド等)の著作権はゼロニーが保持しておりますが営利目的ではない二次利用は可能とします。ご自由にご利用ください。著作権表記なども特に必要ありません。  
...
#### * シューティングゲームのサンプル
![シューティングゲームのサンプル](https://blog-imgs-171.fc2.com/i/6/z/i6zyr7er68b9/SampleSTG_github.gif)
#### * アクションRPGのサンプル
